program main
    ...
    T = 90.5 ! [1.0, 1.1, 1.2, 1.3, 1.5, 2.]
    N = 10000
    h = (6. - 0) / N

    P = 41.37 * 101325! [(0 + h * (i - 1) , i = 1, N + 1)]
...
! gfortran src/mod_peng_robinson.f90 main.f90 -o main && ./main > data_output.dat && gnuplot plot_data.gp